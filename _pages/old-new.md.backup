...
<!-- This is the new modern homepage -->
  ...
  <section class="highlights-section">
    ...
    <div class="publications-grid">
      ...
      <div class="publication-card">
        {% if pub.image %}
        <div class="pub-image">
          <img src="{{ site.baseurl }}/images/{{ pub.image }}" alt="{{ pub.title }}">
        </div>
        {% endif %}
    ...
    <a href="{{ site.baseurl }}/new/publications/" class="view-more">View all publications →</a>
  </section>
</div>
